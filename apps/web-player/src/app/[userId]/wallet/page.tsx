            ...
            <div className="wallet-grid">
                ...
                <Card variant="glass" className="balance-card">
                    <div className="balance-content">
                        ...
                        <div className="amount">RM 150.00</div>
                    ...
                    <div className="transactions-list">
                        <div className="transaction-item">
                            ...
                            <div className="transaction-details">
                                ...
                                <span className="date">Today, 10:30 AM</span>
                            </div>
                            <span className="transaction-amount positive">+ RM 50.00</span>
                        </div>
                        <div className="transaction-item">
                            ...
                            <div className="transaction-details">
                                <span className="title">Match Booking</span>
                                <span className="date">Yesterday, 4:15 PM</span>
                            </div>
                            <span className="transaction-amount negative">- RM 30.00</span>
                        </div>
                        <div className="transaction-item">
                            <div className="transaction-icon sent">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 19V5M5 12l7-7 7 7" /></svg>
